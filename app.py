...
gdf_m = gpd.read_file("C:/Users/Hp/VISUAL/MGN2023_MPIO_POLITICO/MGN_ADM_MPIO_GRAFICO.shp")
...
for _, row in df_despachos.iterrows():
    ...
    if origen in coord_prov and destino in coord_dest:
        loc_origen = [coord_prov[origen]["lat"], coord_prov[origen]["lon"]]
        loc_destino = [coord_dest[destino]["lat"], coord_dest[destino]["lon"]]
        color = "gray"  
